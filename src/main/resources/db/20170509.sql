...
--
-- Dumping data for table `a_name`
--

LOCK TABLES `a_name` WRITE;
/*!40000 ALTER TABLE `a_name` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_name` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `a_rename`
--

DROP TABLE IF EXISTS `a_rename`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `a_rename` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `categoryId` int(2) NOT NULL DEFAULT '0',
  `title` varchar(256) NOT NULL,
  `body` text NOT NULL,
...
--
-- Dumping data for table `a_rename`
--

LOCK TABLES `a_rename` WRITE;
/*!40000 ALTER TABLE `a_rename` DISABLE KEYS */;
/*!40000 ALTER TABLE `a_rename` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `c_name` WRITE;
/*!40000 ALTER TABLE `c_name` DISABLE KEYS */;
/*!40000 ALTER TABLE `c_name` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `c_rename`
--

DROP TABLE IF EXISTS `c_rename`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `c_rename` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `articleId` int(11) NOT NULL,
  `categoryId` int(2) NOT NULL DEFAULT '0',
  `body` text NOT NULL,
...
--
-- Dumping data for table `c_rename`
--

LOCK TABLES `c_rename` WRITE;
/*!40000 ALTER TABLE `c_rename` DISABLE KEYS */;
/*!40000 ALTER TABLE `c_rename` ENABLE KEYS */;
UNLOCK TABLES;
...
--
/*!50003 DROP PROCEDURE IF EXISTS `Article_getTotal` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Article_getTotal`(
	IN  `table` VARCHAR(50),
    OUT `total` INT
)
BEGIN
...
/*!50003 DROP PROCEDURE IF EXISTS `Article_getTotalBySearch` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Article_getTotalBySearch`(
	IN  `table` VARCHAR(50),
    OUT `total` INT,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Comment_getTotal` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Comment_getTotal`(
	IN  `table` VARCHAR(50),
    OUT `total` INT
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `Comment_getTotalBySearch` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Comment_getTotalBySearch`(
	IN  `table` VARCHAR(50),
    OUT `total` INT,
    IN  `keyword` VARCHAR(128)
)
...
-- Dump completed on 2017-05-09 17:25:16
