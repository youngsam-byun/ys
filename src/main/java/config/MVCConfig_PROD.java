...
public class MVCConfig_PROD extends WebMvcConfigurerAdapter {
	...
	public MessageSource messageSource() {
		...
		messageSource.setDefaultEncoding(AppConfig_STG.DEFAULT_ENCODING);
	...
	public LocalValidatorFactoryBean validator() {
		...
		validator.setValidationMessageSource(AppConfig_PROD.messageSource());
		return validator;
	}
